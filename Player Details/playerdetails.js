$(document).ready(function () {
  const teamData = [
    {
      ...
      bgImage: "https://www.iplt20.com/resources/v4.24.0/i/sprites/tLogo158x-sprite.png",
    },
    {
      id: 2,
  ...
  var playerBio = $("<section>")
    .addClass("player-bio")
    .attr("id", "team" + playerData[playerId - 1].from);
  var imgWrapper = $("<div>").addClass("img-wrapper");
  var playerImg = $("<img>")
    .addClass("player-img")
    .attr("src", playerData[playerId - 1].playerImage);
  var playerDetails = $("<div>").addClass("player-detail");
  var playerName = $("<h1>")
    .addClass("player-name")
    .html(playerData[playerId - 1].playerName);
  var teamName = $("<h3>").html("Team Name : " + playerData[playerId - 1].from);
  var price = $("<h4>").html("Price : " + playerData[playerId - 1].price);
  var playingStatus = $("<p>").html("Playing Status : " + playerData[playerId - 1].isPlaying);
  var role = $("<p>").html("Role : " + playerData[playerId - 1].description);

  playerDetails.append(playerName, teamName, price, playingStatus, role);
  imgWrapper.append(playerImg);
  playerBio.append(imgWrapper, playerDetails);
  $("#players").append(playerBio);
});
